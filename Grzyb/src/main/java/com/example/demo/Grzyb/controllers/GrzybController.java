...
public class GrzybController {
    ...
    public ResponseEntity<List<GrzybDTO>> listGrzybs() {
        ...
        for (Grzyb Grzyb : Grzyby) {
            GrzybDTO GrzybDTO = com.example.demo.Grzyb.dto.GrzybDTO.builder().name(Grzyb.getName())
                    .description(Grzyb.getDescription()).imageURL(Grzyb.getImageURL()).build();
    ...
    public ResponseEntity<GrzybDTO> getGrzybByName(@PathVariable("name") String name) {
        ...
        if (Grzyb != null) {
            GrzybDTO GrzybDTO = com.example.demo.Grzyb.dto.GrzybDTO.builder().name(Grzyb.getName())
                    .description(Grzyb.getDescription()).imageURL(Grzyb.getImageURL()).imageURL2(Grzyb.getImageURL2())
                    .imageURL3(Grzyb.getImageURL3()).build();
